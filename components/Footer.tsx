...
const Footer : React.FC = () => {
  ...
  return (
    <footer id='footer' className="bg-gray-900 text-gray-300 mt-5 ">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm">
              Share your knowledge, learn from others, and grow together in our community of writers and developers.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/blogs?category=technology" className="hover:text-white transition-colors duration-200">
                  View Current Votings
                </Link>
              </li>
              <li>
                <Link href="/blogs?category=web-development" className="hover:text-white transition-colors duration-200">
                  About
                </Link>
              </li>
              <li>
                <Link href="/blogs?category=ai" className="hover:text-white transition-colors duration-200">
                  Contact
                </Link>
              </li>
              <li>
                <Link href="/blogs?category=design" className="hover:text-white transition-colors duration-200">
                  become our developer
                </Link>
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm">
              © {new Date().getFullYear()} AGC.Info. All rights reserved.
            </p>
