...
import { PinIcon, PlusIcon, UnplugIcon } from 'lucide-react';
    ...
    return (
        <div key={collection.id} className="bg-gradient-to-br from-indigo-50 to-purple-50 rounded-lg p-4 shadow-md border border-gray-200 hover:shadow-lg transition-all duration-200 max-[500px]:w-full min-w-[30%]">
            <div className="flex items-center mb-2">
                ...
                {(path !== "dashboard") && <motion.button whileTap={{ scale: 0.95 }} onClick={() => { addCollection() }} className='h-8 w-8 ml-auto hover:bg-green-100 border hover:border-green-300 border-white/10  rounded-full flex justify-center items-center'>
