...
const Bottom: React.FC = () => {
  return (
    <div className='min-h-16 bg-white/30 shadow-gray-500 shadow-xl rounded-xl border border-white/20 backdrop-blur-2xl absolute w-80 bottom-4 left-4 px-4 flex justify-between items-center'>
